...
class CustomDataset(Dataset):
    ...
    def get_default_transform(self):
        ...
        default_transform = A.Compose([
            ...
            # A.Normalize(mean=(0, 0, 0, 0, 0, 0), std=(1, 1, 1, 1, 1, 1)),
            A.Normalize(mean=(0.4758, 0.4873, 0.5098, 0.4758, 0.4873, 0.5098),
                        std=(0.1670, 0.1496, 0.1477, 0.1670, 0.1496, 0.1477)),
            ToTensorV2()
        ])
    ...
    def get_gt_seg_maps(self, img_info, vis=False):
        ...
        # anns = [(ann == v) for v in class_values]
        # ann = np.stack(anns, axis=-1).astype('float')
